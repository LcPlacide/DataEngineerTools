...
from controls2 import init_components, make_request, select_anime, print_infos
...
def build_advance_search():
    return [html.Div([
        ...
        html.Div([
                html.Div([dcc.Markdown(id="anime_infos")],
...
if __name__ == '__main__':
    ...
    def print_search_result(submit,back,next,
        Type,rating,status,
